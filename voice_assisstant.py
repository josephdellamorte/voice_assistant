...
class voice_assistant():
    ...
    def process_file(self,file):
        ...
        archibald=fuzz.partial_ratio("how much wood could a wood chuck chuck if a wood chuck could chuck wood?",lower_text)
        if verbosity:
        ...
        if (hpk > 90) | (hppk > 90):
            helper.aprint('hey user! whats up?')
        elif (hmmsdwh> 90):
            helper.aprint("I'm not sure but in the future I might be able to tell you")
        elif (archibald > 90):
            helper.aprint("Depending on age and size, about a quart and a half.")
